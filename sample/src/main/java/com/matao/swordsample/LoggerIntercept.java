...
/**
 * Created by matao on 2016-12-22 13:56
 */

public class LoggerIntercept implements Interceptor {
    public static final String TAG = "LoggerIntercept";
    private String tag;
    private boolean showResponse;

    public LoggerIntercept(String tag, boolean showResponse) {
    ...
    public LoggerIntercept(String tag) {
        this(tag, false);
    }
